...
| Focused tests | Retain `tests/simulator/test_buff_attribute_reader.py::test_migrated_reader_seam_regression_samples_match_retained_helpers[regular-crit-received-boundary]`, `::test_p2b_parity_fixture_matches_old_full_and_personal_crit_rate_helpers[baseline]`, `[field-buff]`, `[flat-buff]`, `[received-enemy-debuff]`, `[no-buff]`, `::test_p2b_full_crit_rate_includes_received_bonus_but_personal_excludes`, and `::test_calculator_regular_mul_crit_formula_families_preserve_received_boundaries[received-fields-excluded-from-personal-values]` as the focused oracle / reader proof set. |
