...
GENERATED_DIR = Path(
    "zsim/sim_progress/BuffGraph/generated_specs/yuzuha-cinema2-qte-signal-cases"
)
ORACLE_ROOT = Path("tests/fixtures/buff_graph/generated-spec-legacy-oracles")


def test_yuzuha_qte_generated_spec_legacy_oracle_batch_is_complete_and_consumable() -> None:
    ...
    for spec_path, wrapper in wrappers:
        ...
        assert fixture["migration_wave"] == "yuzuha-cinema2-qte-signal-cases"
