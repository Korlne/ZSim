...
@pytest.mark.parametrize(
    "fixture_name",
    [
        "cordis-germina-crit-rate-bonus-candidate.json",
        "rainforest-gourmet-atk-bonus-candidate.json",
        "astra-yao-idyllic-cadenza-candidate.json",
    ],
)
def test_pure_low_risk_generated_spec_candidate_harness_matches_fixture(
    fixture_name: str,
) -> None:
