...
@pytest.mark.parametrize(
    ...
    [
        ...
        "elegant-vanity-sp-recover-candidate.json",
        "sliceof-time-extra-resources-candidate.json",
    ],
)
def test_calculator_generated_spec_candidate_harness_matches_fixture(
    fixture_name: str,
) -> None:
    ...
    result = run_buff_graph_candidate_parity(
        ...
        adapters=_calculator_candidate_adapters(),
        tick=case["tick"],
...
def _calculator_candidate_adapters() -> dict[str, object]:
