...
@pytest.mark.parametrize(
    ...
    [
        ...
        "branch-blade-song-crit-damage-bonus-candidate.json",
        "magnetic-storm-charlie-sp-recover-candidate.json",
    ],
)
def test_runtime_scheduled_generated_spec_candidate_harness_matches_fixture(
    fixture_name: str,
) -> None:
    ...
    result = run_buff_graph_candidate_parity(
        ...
        adapters=_runtime_scheduled_candidate_adapters(),
        tick=case["tick"],
...
def _runtime_scheduled_candidate_adapters() -> dict[str, object]:
