...
@pytest.mark.parametrize(
    ...
    [
        ...
        "yanagi-polarity-disorder-trigger-candidate.json",
        "miyabi-additional-ability-ignore-ice-res-candidate.json",
    ],
)
def test_dot_anomaly_generated_spec_candidate_harness_matches_fixture(
    fixture_name: str,
) -> None:
    ...
    result = run_buff_graph_candidate_parity(
        ...
        adapters=_dot_anomaly_candidate_adapters(),
        tick=case["tick"],
...
def _dot_anomaly_candidate_adapters() -> dict[str, object]:
