...
GENERATED_DIR = Path(
    "zsim/sim_progress/BuffGraph/generated_specs/calculator-runtime-formula-cases"
)
ORACLE_ROOT = Path("tests/fixtures/buff_graph/generated-spec-legacy-oracles")


def test_calculator_generated_spec_legacy_oracle_batch_is_complete_and_consumable() -> None:
    ...
    for spec_path, wrapper in wrappers:
        ...
        assert fixture["migration_wave"] == "calculator-runtime-formula-cases"
